...
HD_PWD='C:/Users/thear/Documents/college/Year 2/DIGITAL DESIGN Fall 2022/Vivado/project_5/project_5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sqrt_Top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sqrt_Top.tcl -notrace
