...
HD_PWD='C:/Users/thear/Documents/college/Year 2/DIGITAL DESIGN Fall 2022/Vivado/project_4/project_4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log updownCounter_Top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source updownCounter_Top.tcl -notrace
