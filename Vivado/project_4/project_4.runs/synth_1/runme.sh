...
HD_PWD='C:/Users/thear/Documents/college/Year 2/DIGITAL DESIGN Fall 2022/Vivado/project_4/project_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log updownCounter_Top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source updownCounter_Top.tcl
